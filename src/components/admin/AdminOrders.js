    ...
    <Fragment>
      ...
      <div className="d-flex justify-content-center align-items-center">
        <div style={{ marginRight: "10px" }}>
          <button>
            <Link target="_blank" to="/allsales">
              Generate All Sales
            </Link>
          </button>
        </div>
        <div style={{ marginLeft: "10px" }}>
          <button>
            <Link target="_blank" to="/allstorno">
              Generate All Storno
            </Link>
          </button>
        </div>
            ...
            {data.map((val, index) => {
              return (
                <tr key={index}>
                  ...
                  <td>
                    <Link target="_blank" to={`/salesreport/${val.id}`}>
                      Generate Sales Report
                    </Link>{" "}
                  </td>
                  <td>
                    {val.orderStatus === "Cancel" ? (
                      <Link target="_blank" to={`/stornoreport/${val.id}`}>
                        Generate Storno Report
                      </Link>
                    ) : (
                      <span>Order is not cancelled</span>
                    )}
                  </td>
                </tr>
              );
