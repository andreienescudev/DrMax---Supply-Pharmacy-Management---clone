...
const StornoReport = () => {
  ...
  const downloadPdfDocument = (rootElementId) => {
    ...
    html2canvas(input).then((canvas) => {
      ...
      pdf.save(`StornoReport_${orderNo}'.pdf`);
    });
  };
        ...
        >
          ...
          <div>
            <h1 style={{ margin: "0", textAlign: "center" }}>
              Storno Invoice: <br></br>
              <h5>{orderNo}</h5>
            </h1>
            <p
              style={{ margin: "0", display: "flex", justifyContent: "center" }}
            >
              <span style={{ marginRight: "5px" }}>Serie: ABC123</span>
              <span style={{ marginLeft: "2px" }}>Data: {createdOn}</span>
            </p>
          </div>
        </div>
            ...
            <tr>
              ...
              >
                <div style={{ textAlign: "right", marginBottom: "20px" }}>
                  <h3>
                    <strong>Refund Amount:</strong> {-orderTotal} RON
                  </h3>
                </div>
              </td>
            </tr>
