...
namespace EMedicineBE.Models
{
    public class DAL
    {
        public Response register(Users users, SqlConnection connection)
        {
            ...
            // Verifică dacă adresa de e-mail există deja
            ...
            // Dacă adresa de e-mail nu există, înregistrează noul utilizator
            if (emailCount == 0)
            {
            ...
            else
            {
                ...
                response.StatusMessage = "Email address already exists";
            }
